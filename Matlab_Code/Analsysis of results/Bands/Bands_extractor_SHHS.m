...
close all
%%
NName='SHHS_ECG_Spectrums.mat';
load(['C:\Users\Teitur\Desktop\School\Thesis\Code\Processing Data\Bands\SHHS\Step1\' NName])

%% rem features

load('SHHS_nsrrid.mat') %nsrrid_left
